...
class GeneralSettings extends Component
{
    ...
    public $saved = false;
    public  $key,$value;
    public $site_name,$site_email,$site_phone,$site_default_currency,$site_currency_icon,$site_currency_icon_position,$site_timezone;
    public $setting;
    public $model_id;
    ...
    public function mount()
    {
        ...
        $this->site_timezone = $model['site_timezone'];
    ...
    {
        return view('livewire.admin.settings.sections.general-settings');
    }
