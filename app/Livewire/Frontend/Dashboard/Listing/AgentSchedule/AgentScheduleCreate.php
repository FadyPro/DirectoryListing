...
class AgentScheduleCreate extends Component
{
    public $listing_id;
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.dashboard.listing.agent-schedule.agent-schedule-create', compact('listingTitle'));
    }
    ...
    public function save()
    {
        ...
        return redirect()->to(route('user.listing-schedule.index', $this->listing_id));
    }
