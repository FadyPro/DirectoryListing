            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.amenity.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td><i class="{{$models->icon}}" style="font-size:30px"></i></td>
                                    <td>{{$models->name}}</td>
                                    <td>{{$models->slug}}</td>
                                    <td>
                                        @if($models->status === 1)
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/amenity/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
