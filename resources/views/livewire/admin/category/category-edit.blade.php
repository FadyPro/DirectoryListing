                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                @else
                                    <img src="{{(!empty($category->image_icon))? url('/uploads/'.$category->image_icon) : url('/uploads/background.png')}}" style="width: 100px; height: 100px">
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                @else
                                    <img src="{{(!empty($category->background_image))? url('/uploads/'.$category->background_image) : url('/uploads/background.png')}}" style="width: 100px; height: 100px">
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
