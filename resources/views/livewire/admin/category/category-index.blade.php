        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Categories List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.category.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{(!empty($models->image_icon))? url('/uploads/'.$models->image_icon) : url('/uploads/background.png')}}" style="width: 100px; height: 100px">
                                    </td>
                                    <td>
                                        <img src="{{(!empty($models->background_image))? url('/uploads/'.$models->background_image) : url('/uploads/background.png')}}" style="width: 100px; height: 100px">
                                    </td>
                                    <td>{{$models->name}}</td>
                                    <td>{{$models->slug}}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/category/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
