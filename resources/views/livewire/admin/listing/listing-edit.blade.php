                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div>
                                                ...
                                                @else
                                                    <img src="{{(!empty($listing->image))? url('/uploads/listing/'.$listing->image) : url('/uploads/background.png')}}" style="width: 100px; height: 100px">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div>
                                                ...
                                                @else
                                                    <img src="{{(!empty($listing->thumbnail_image))? url('/uploads/listing/'.$listing->thumbnail_image) : url('/uploads/background.png')}}" style="width: 100px; height: 100px">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
