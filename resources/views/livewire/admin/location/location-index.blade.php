            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.location.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/location/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
