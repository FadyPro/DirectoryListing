        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Order List</h4>
                    <div>
                            ...
                            <tr>
                                ...
                                <th wire:click="setSortBy('email')" style="cursor: pointer">
                                    <a> email
                                        @if( $sortBy !== 'email')
                                            <i class="fas fa-solid fa-arrow-up"></i>
                                        @elseif( $sortBy === 'email' && $sortDirection === 'asc')
                                            <i class="fas fa-solid fa-arrow-down"></i>
                                        @else
                                            <i class="fas fa-solid fa-arrow-up"></i>
                                        @endif
                                ...
                                <th wire:click="setSortBy('package')" style="cursor: pointer">
                                    <a> Package
                                        @if( $sortBy !== 'package')
                                            <i class="fas fa-solid fa-arrow-up"></i>
                                        @elseif( $sortBy === 'package' && $sortDirection === 'asc')
                                            <i class="fas fa-solid fa-arrow-down"></i>
                                        @else
                                            <i class="fas fa-solid fa-arrow-up"></i>
                                        @endif
