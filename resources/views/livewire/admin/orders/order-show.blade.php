        ...
        <div class="section-body">
            <div class="invoice">
                                    ...
                                    <div class="col-md-4">
                                        <form wire:submit="updateOrderStatus">
                                            ...
                                            <div class="form-group">
                                                <select wire:model="payment_status" name="payment_status" id="" class="form-control">
                ...
                <div class="text-md-right">
                    ...
                    <button wire:click="pdfInvoice" class="btn btn-warning btn-icon icon-left" id="print_btn"><i class="fas fa-print"></i>
                        Print</button>
                </div>
            </div>
        </div>
