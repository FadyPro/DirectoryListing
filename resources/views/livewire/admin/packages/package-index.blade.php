        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Locations List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.packages.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/packages/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
                                        @if ($models->trashed())
                                            <a href="javascript:;" wire:click.prevent="restoreDeleted({{$models->id}})" class="btn btn-success restore-item ml-2"><i class='fas fa-undo'></i></a>
                                        @else
