            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="wsus__payment_area">
                        <div class="row">
                            @if (config('payment.paypal_status') == 1)
                                <div class="col-lg-3 col-6 col-sm-4">
                                    <a class="wsus__single_payment"
                                       href="{{ route('paypal.payment') }}">
                                        <img src="{{ asset('uploads/'.config('payment.paypal_image')) }}" alt="payment method" class="img-fluid w-100">
                                    </a>
                                </div>
                            @endif

                            @if (config('payment.stripe_status') == 1)
                                <div class="col-lg-3 col-6 col-sm-4">
                                    <a class="wsus__single_payment" href="{{ route('stripe.payment') }}">
                                        <img src="{{ asset('uploads/'.config('payment.stripe_image')) }}" alt="payment method" class="img-fluid w-100">
                                    </a>
                                </div>
                            @endif
                            @if (config('payment.razorpay_status') == 1)
                                <div class="col-lg-3 col-6 col-sm-4">
                                    <a class="wsus__single_payment" href="{{ route('razorpay.redirect') }}">
                                        <img src="{{ asset('uploads/'.config('payment.razorpay_image')) }}" alt="payment method" class="img-fluid w-100">
                                    </a>
                                </div>
                            @endif
                        </div>
