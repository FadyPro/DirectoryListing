<div>
   ...
   ===========================-->
    ...
    background: url({{ "/uploads/listing/".$listing->thumbnail_image }});
                    ...
                    <div class="listing_details_text">
                        <div class="listing_det_header">
                            <div class="listing_det_header_img">
                                <img src="{{ asset('/uploads/profile/'.$listing->user->avatar) }}" alt="logo" class="img-fluid w-100">
                            </div>
                        ...
                        <div wire:ignore class="listing_det_Photo">
                            <div class="row">

                            @foreach ($listing->gallery as $image)
                                    <div class="col-xl-3 col-sm-6">
                                        <a class="venobox" data-gall="gallery01" href="{{ asset('/uploads/listing/'.$image->image) }}">
                                            <img src="{{ asset('/uploads/listing/'.$image->image) }}" alt="gallery1" class="img-fluid w-100">
                                        ...
                                        @foreach ($smellerListings as $smellerListing)
                                            <a href="{{ route('listing.show', $smellerListing->slug) }}" class="sidebar_blog_single">
                                                <div class="sidebar_blog_img">
                                                    <img src="{{ asset('/uploads/listing/'.$image->image) }}" alt="{{ $smellerListing->title }}" class="imgofluid w-100">
                                                </div>
