    ...
    <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown"
                    ...
                    <img src="{{(!empty(auth()->user()->avatar))? url('/uploads/profile/'.auth()->user()->avatar) : url('/uploads/avatar.png')}}" alt="user" class="img-rounded-circle mr-1">
...
{{--                            @can('payment settings index')--}}
                                <li class="{{ setSidebarActive(['admin.paypal-settings.index']) }}"><a class="nav-link" href="{{ route('admin.paypal-settings.index') }}">Payment Settings</a></li>
{{--                            @endcan--}}
                        </ul>
                    </li>
{{--                @endcan--}}
...
{{--                @can('settings index')--}}
                    <li class="{{ setSidebarActive(['admin.settings.general']) }}" ><a class="nav-link" href="{{ route('admin.settings.general') }}"><i class="fas fa-cogs"></i> <span>Settings</span></a></li>
{{--                @endcan--}}
